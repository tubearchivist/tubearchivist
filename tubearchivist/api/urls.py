...
urlpatterns = [
    ...
    path(
        "backup/", views.BackupApiListView.as_view(), name="api-backup-list",
    ),
    path(
        "backup/<str:filename>/",
    ...
    path(
        "config/user/", views.UserConfigView.as_view(), name="api-config-user",
    ),
    ...
    path(
        "stats/video/", views.StatVideoView.as_view(), name="api-stats-video",
    ),
    path(
        "stats/channel/",
