...
## Screenshots
![login screenshot](assets/tube-archivist-login.webp?raw=true "Tube Archivist Login")  
*Login Page*: Secure way to access your media collection.

![home screenshot](assets/tube-archivist-home.webp?raw=true "Tube Archivist Home")  
*Home Page*: Your recent videos, continue watching incomplete videos.

![channels screenshot](assets/tube-archivist-channels.webp?raw=true "Tube Archivist Channels")  
*All Channels*: A list of all your indexed channels, filtered by subscribed only.

![single channel screenshot](assets/tube-archivist-single-channel.webp?raw=true "Tube Archivist Single Channel")  
*Single Channel*: Single channel page with additional metadata and sub pages.

![video page screenshot](assets/tube-archivist-video.webp?raw=true "Tube Archivist Video Page")  
*Video Page*: Stream your video directly from the interface.

![video page screenshot](assets/tube-archivist-download.webp?raw=true "Tube Archivist Video Page")  
